(function(){
    ...
    var propMenu = {
        burger_menu: document.getElementById("menu-hamburguesa"),
        slideMenu: document.getElementById("menu-slide"),
        menu_activo: false,
        elem_menu: document.querySelectorAll("#menu-slide ul li a")
    }
